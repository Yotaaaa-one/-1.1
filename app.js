...
const SETTINGS_KEY = "pga-tour-18-settings-v1";
const COURSE_SELECTION_KEY = "pga-tour-18-course-v1";
const DEFAULT_GAME_SETTINGS=Object.freeze({showHoleIntro:true,enableSwingAnimation:true,enableBallAnimation:true,animationSpeed:"normal"});
const ROUND_MODES=[{holes:3,label:"3H"},{holes:9,label:"9H"},{holes:18,label:"18H"}];
const CHARACTERS=[
  {id:"balance",name:"バランスプロ",type:"バランスタイプ",tag:"BALANCED",initial:"B",accent:"blue",description:"飛距離、ゲージ幅、方向性が平均的。初心者にも扱いやすい万能型。",power:78,accuracy:78,control:78,shortGame:78,putting:78,traits:["飛距離○","ゲージ標準","方向性○"],performance:{baseDistanceMultiplier:1,perfectZoneMultiplier:1,goodZoneMultiplier:1,sideMissMultiplier:1,approachStabilityMultiplier:1,puttZoneMultiplier:1},images:{icon:"assets/characters/balance/icon.png",bust:"assets/characters/balance/bust.png",full:"assets/characters/balance/full.png"}},
  {id:"power",name:"パワープロ",type:"パワータイプ",tag:"POWER",initial:"P",accent:"red",description:"最も飛距離が出る一方、ゲージは狭めで左右ブレが大きい豪快型。",power:92,accuracy:62,control:66,shortGame:70,putting:70,traits:["飛距離◎","ゲージ狭め","ブレ大"],performance:{baseDistanceMultiplier:1.1,perfectZoneMultiplier:.8,goodZoneMultiplier:.9,sideMissMultiplier:1.24,approachStabilityMultiplier:.94,puttZoneMultiplier:.96},images:{icon:"assets/characters/power/icon.png",bust:"assets/characters/power/bust.png",full:"assets/characters/power/full.png"}},
  {id:"technique",name:"テクニックプロ",type:"テクニックタイプ",tag:"TECHNIQUE",initial:"T",accent:"violet",description:"飛距離は控えめだが、ゲージが広く方向性とアプローチが安定。",power:68,accuracy:88,control:86,shortGame:88,putting:86,traits:["ゲージ広め","方向安定","飛距離控えめ"],performance:{baseDistanceMultiplier:.92,perfectZoneMultiplier:1.3,goodZoneMultiplier:1.22,sideMissMultiplier:.78,approachStabilityMultiplier:1.18,puttZoneMultiplier:1.12},images:{icon:"assets/characters/technique/icon.png",bust:"assets/characters/technique/bust.png",full:"assets/characters/technique/full.png"}}
];
...
const URBAN_HOLE_DATA=[
  ...
  {name:"屋上グリーンチャレンジ",par:5,yards:515,difficulty:5,leftRisk:4,rightRisk:4,waterRisk:0,bunkerRisk:3,obSide:"both",district:"ROOFTOP EAST",tone:"day",features:["rooftop","buildings"],comment:"強めに打てば2オン可能。ただし屋上外はOBです。",fairwayLabel:"屋上人工芝",roughLabel:"屋上植栽帯",bunkerLabel:"屋上砂利エリア",waterLabel:"",obLabel:"屋上外",greenLabel:"屋上グリーン"},
  {name:"高架下テクニカル",par:4,yards:388,difficulty:4,leftRisk:3,rightRisk:4,waterRisk:0,bunkerRisk:4,obSide:"right",district:"UNDERPASS",tone:"day",features:["rail","road","construction"],comment:"高架下を抜くテクニカルホール。普通に打って安全に運ぶ判断も有効です。",fairwayLabel:"高架下イベント広場",roughLabel:"植え込みラフ",bunkerLabel:"工事砂場",waterLabel:"",obLabel:"高架立入禁止",greenLabel:"高架下特設グリーン"},
  ...
  {name:"リバークロス",par:4,yards:420,difficulty:5,leftRisk:3,rightRisk:4,waterRisk:5,bunkerRisk:2,obSide:"none",waterSide:"right",windFactor:1.3,district:"RIVER CROSS",tone:"sunset",features:["river","bridge","buildings"],comment:"川を斜めに越える勝負所。強めに打つほどWHリスクが上がります。",fairwayLabel:"リバーサイド通路",roughLabel:"河川敷の深い芝",bunkerLabel:"河川敷の砂地",waterLabel:"RIVER",obLabel:"河川立入禁止",greenLabel:"リバークロスグリーン"},
  ...
  {name:"オフィス街ドッグレッグ",par:4,yards:435,difficulty:4,leftRisk:5,rightRisk:3,waterRisk:0,bunkerRisk:2,obSide:"left",district:"OFFICE DOGLEG",tone:"night",features:["buildings","road","neon"],comment:"ビルを避けるドッグレッグ。左は近道ですがOB、中央に置く判断も有効です。",fairwayLabel:"オフィス街イベント通路",roughLabel:"街路樹の根元",bunkerLabel:"砂利エリア",waterLabel:"",obLabel:"ビル外",greenLabel:"オフィス街グリーン"},
  {name:"ルーフトップPar5",par:5,yards:548,difficulty:5,leftRisk:4,rightRisk:5,waterRisk:0,bunkerRisk:3,obSide:"both",district:"ROOFTOP WEST",tone:"night",features:["rooftop","buildings","neon"],comment:"屋上から屋上へ渡る名物ホール。強めに狙うか安全に進めるかを見極めましょう。",fairwayLabel:"屋上人工芝",roughLabel:"屋上植栽帯",bunkerLabel:"屋上砂利エリア",waterLabel:"",obLabel:"屋上外",greenLabel:"ルーフトップグリーン"},
...
const GREEN_CITY_HOLES=URBAN_HOLE_DATA.map((hole,index)=>({number:index+1,...hole,...URBAN_VISUAL_DATA[index],courseDifficulty:"NORMAL",urbanRisk:hole.difficulty,fairwayWidth:hole.difficulty>=5?"narrow":"standard",obRiskMultiplier:1,visualDensity:3}));
const SHIBUYA_HOLE_ROWS=[
  ["スクランブル・オープナー",4,382,"crossing","day","スクランブル広場風","shibuya_crossing","広場型の開幕ホール。左右は道路OB、中央の人工芝フェアウェイを狙いましょう。",3,3,0,2,"both","center",1.05],
  ["センターストリート",4,348,"shopping","day","商店街ストリート","narrow_street","細いストリートを抜ける方向性重視ホール。強めに打つとOBリスク高め。",5,5,0,1,"both","center",1.1],
  ["ミヤシタ・ルーフ",3,161,"rooftop","day","屋上人工芝","rooftop_green","屋上風の短いPar3。グリーンを外すと屋上外OBです。",4,4,0,3,"both","center",1.18],
  ["ビル風キャニオン",4,421,"business","day","高層ビル谷間","building_canyon","高層ビルの谷間を抜ける難ホール。ビル風で左右ブレが大きくなります。",5,5,0,2,"both","center",1.55],
  ["ドッグレッグ坂道",5,522,"slope","sunset","坂道ストリート","sloped_road","坂道を上がるPar5。右の近道はOBリスク、左に置くと安全です。",3,5,0,2,"right","left",1.22],
  ["高架下トンネル",4,376,"overpass","sunset","高架下","underpass","高架下をくぐるテクニカルホール。中央へ低く運ぶイメージが安全です。",3,4,0,3,"right","center",1.2],
  ["ネオン・ショート",3,144,"neon","sunset","ネオン看板","neon_short","ネオンが灯る短いPar3。グリーン周りの都市バンカーに注意。",3,3,0,4,"none","center",1.16],
  ["スクエア・ドライブ",4,402,"plaza","sunset","イベント広場","city_plaza","中央は広め。強めに打つ場合は左右の道路OBに注意しましょう。",4,4,0,2,"both","center",1.12],
  ["シブヤゲート",5,541,"gate","sunset","ビルゲート","urban_gate","前半の締め。ビルゲートを抜けてグリーンへ向かう勝負ホールです。",4,4,0,3,"both","center",1.28],
  ["ナイトクロッシング",4,389,"crossing","night","夜の交差点","night_crossing","夜景の交差点ホール。派手な景観に惑わされず狭い中央レーンへ。",5,5,0,2,"both","center",1.22],
  ["レールサイド",4,415,"rail","night","線路沿い","rail_side","線路沿い風のホール。右OBを避けて中央からやや左が安全です。",3,5,0,2,"right","left",1.34],
  ["バックアレー・バンカー",3,153,"alley","night","裏路地砂利","alley_bunker","裏路地の都市バンカーに囲まれたPar3。距離感を優先しましょう。",3,3,0,5,"none","center",1.12],
  ["タワーサイド",4,436,"tower","night","シティタワー風","tower_side","高層タワー横を抜ける長いPar4。ビル風と道路OBに注意。",5,4,0,2,"both","center",1.52],
  ["ルーフトップ・ロング",5,556,"rooftop","night","連絡屋上","rooftop_long","屋上から屋上へつなぐPar5。飛距離を稼げますが屋上外はOBです。",5,5,0,3,"both","center",1.38],
  ["パークサイド・リリーフ",4,391,"park","night","小公園","night_park","終盤では比較的安全な公園横ホール。中央からバーディを狙えます。",2,2,2,2,"none","center",1.08],
  ["サインボードPar3",3,181,"neon","night","巨大サインボード","signboard_par3","巨大看板を背にしたPar3。左右の大きなミスはトラブルになります。",4,4,0,3,"both","center",1.24],
  ["ファイナル・アベニュー",4,442,"avenue","night","大通り","final_avenue","狭い大通りを進む難ホール。強めに打つか中央へ運ぶかの判断です。",5,5,0,2,"both","center",1.4],
  ["シブヤ・グランドフィナーレ",5,568,"finale","night","シブヤ夜景タワー","shibuya_finale","夜景のシティグリーンへ向かう最終ホール。イーグルもOBもある勝負所。",5,5,2,4,"both","right",1.5]
];
...
const COURSES={
  ...
  shibuya:{courseId:"shibuya",courseName:"SHIBUYA URBAN COURSE",shortName:"SHIBUYA",region:"tokyo-inspired",difficulty:"HARD",status:"available",courseType:"東京インスパイア都市コース",description:"狭い人工芝レーンとビル風を攻略する、架空の高難度シティコース。",features:"狭いフェアウェイ / ビル風 / ネオン / 屋上グリーン",landmarks:"スクランブル広場風、坂道ストリート、ルーフトップ",holes:SHIBUYA_HOLES},
  odaiba:{courseId:"odaiba",courseName:"ODAIBA BAY COURSE",shortName:"ODAIBA",region:"tokyo-inspired",difficulty:"TBA",status:"comingSoon",courseType:"湾岸ウォーターフロント",description:"湾岸、橋、海風、ウォーターハザードを巡るコース。",features:"海風 / 橋 / ウォーターハザード",landmarks:"ベイブリッジ風、海浜広場",holes:[]},
  westTokyo:{courseId:"westTokyo",courseName:"WEST TOKYO PARK COURSE",shortName:"WEST TOKYO",region:"tokyo-inspired",difficulty:"TBA",status:"comingSoon",courseType:"自然共生パークコース",description:"公園、川沿い、住宅地を巡る初心者向けバランスコース。",features:"公園 / 川沿い / 自然",landmarks:"緑地公園、リバーサイド",holes:[]}
};
let selectedCourseId="greenCity",holes=COURSES.greenCity.holes;
function courseById(id){return COURSES[id]||COURSES.greenCity}
function activateCourse(id,persist=false){const course=courseById(id);selectedCourseId=course.status==="available"?course.courseId:"greenCity";holes=COURSES[selectedCourseId].holes;if(globalThis.PGAEngine)globalThis.PGAEngine.holes=holes;if(persist)try{localStorage.setItem(COURSE_SELECTION_KEY,selectedCourseId)}catch{}return COURSES[selectedCourseId]}
...
const FIELD_SHOT_FALLBACK=Object.freeze([
  {id:"normal",name:"普通に打つ",desc:"安定重視の標準ショット",risk:0,power:1,recommended:true},
  {id:"attack",name:"強めに打つ",desc:"飛距離重視。ミス時のブレが大きい",risk:4,power:1.15}
]);
const TIMING_PROFILES={
  normal:{key:"normal",label:"STANDARD",perfect:8,good:20,normal:32,miss:48},
  attack:{key:"attack",label:"STRONG · HIGH RISK",perfect:5,good:15,normal:28,miss:44},
...
let state=loadState(), gameSettings=loadGameSettings(state), resultTimer, timingFrame, timingStart=0, timingPosition=0, pendingShot=null, pendingTimingProfile=null, shotAnimationFrame, isShotAnimating=false, shotLocked=false, holeIntroOpen=false, selectedCharacterId="balance", selectedRoundHoles=18;
state.skipHoleIntro=!gameSettings.showHoleIntro;

function characterPerformance(characterOrId){const character=typeof characterOrId==="string"?characterById(characterOrId):characterOrId;return character?.performance||CHARACTERS[0].performance}
function clampProfile(profile){const perfect=Math.max(2,Math.min(22,+profile.perfect.toFixed(1))),good=Math.max(perfect+3,Math.min(55,+profile.good.toFixed(1))),normal=Math.max(good+5,Math.min(78,+profile.normal.toFixed(1))),miss=Math.max(normal+7,Math.min(94,+profile.miss.toFixed(1)));return{...profile,perfect,good,normal,miss}}
function normalizeShotId(id){return id==="layup"?"normal":id==="strong"?"attack":id||"normal"}
const LEGACY_ATTACK_LABEL=["攻め","て打つ"].join(""),LEGACY_LAYUP_LABEL=["刻ん","で打つ"].join("");
function displayShotChoice(choice){return choice===LEGACY_ATTACK_LABEL?"強めに打つ":choice===LEGACY_LAYUP_LABEL?"普通に打つ":choice}
function isStrongChoice(choice){return displayShotChoice(choice)==="強めに打つ"}
function normalizeShotOption(option){const id=normalizeShotId(option?.id);if(id==="attack")return{...FIELD_SHOT_FALLBACK[1],...option,id,name:"強めに打つ",desc:option?.desc||FIELD_SHOT_FALLBACK[1].desc};return{...FIELD_SHOT_FALLBACK[0],...option,id:"normal",name:"普通に打つ",desc:option?.desc||FIELD_SHOT_FALLBACK[0].desc}}
function timingProfileFor(opt,current){
  if(current.lie!=="green"){const base=TIMING_PROFILES[normalizeShotId(opt.id)]||TIMING_PROFILES.normal,performance=characterPerformance(current.characterId);return clampProfile({...base,perfect:base.perfect*performance.perfectZoneMultiplier,good:base.good*performance.goodZoneMultiplier})}
  const d=current.distance;
  const profile=d<=1?TIMING_PROFILES.puttShort:d<=3?TIMING_PROFILES.puttNear:d<=6?TIMING_PROFILES.puttStandard:d<=10?TIMING_PROFILES.puttLong:TIMING_PROFILES.puttVeryLong,putt=characterPerformance(current.characterId).puttZoneMultiplier||1;
  return clampProfile({...profile,perfect:profile.perfect*putt,good:profile.good*putt});
}
...
async function playSpriteFrames(target,paths,character,isPutt,speed=1){for(let index=0;index<paths.length;index++){target.src=paths[index];target.dataset.frame=String(index+1);const delay=Math.max(40,Math.round(spriteDelayFor(character,isPutt,index)*speed));await new Promise(resolve=>setTimeout(resolve,delay))}}
...
function freshState(name="PLAYER",characterId=selectedCharacterId,roundHoles=selectedRoundHoles,courseId=selectedCourseId){
  const course=activateCourse(courseId),character=characterById(characterId),courseHoles=course.holes;
  const cpu=cpuNames.map((name,i)=>{const skill=69+Math.floor(Math.random()*22);return{name,skill,scores:simulateCpu(skill,courseHoles,course.courseId),country:["USA","JPN","KOR","ENG","NOR","AUS","SWE"][i%7]}});
  return{version:7,courseTheme:COURSE_THEME,courseId:course.courseId,selectedCourseId:course.courseId,courseName:course.courseName,started:true,complete:false,roundHoles:roundModeByHoles(roundHoles).holes,finalResult:null,seenHoleIntroIds:[],skipHoleIntro:false,name:name.trim().toUpperCase()||"PLAYER",selectedCharacterId:character.id,characterId:character.id,characterName:character.name,power:character.power,accuracy:character.accuracy,control:character.control,shortGame:character.shortGame,putting:character.putting,aim:"center",lastShotOrigin:null,hole:0,strokes:0,lie:"tee",distance:courseHoles[0].yards,position:{progress:0,lateral:0},greenPosition:null,winds:courseHoles.map(()=>+(1+Math.random()*5).toFixed(1)),scores:Array(18).fill(null),shots:Array.from({length:18},()=>[]),cpu};
}
function migrate(saved){
  if(!saved?.started)return saved||{started:false};
  const legacyCourseId=saved.courseId||saved.selectedCourseId,course=activateCourse(COURSES[legacyCourseId]?.status==="available"?legacyCourseId:"greenCity"),character=characterById(saved.characterId||saved.selectedCharacterId);saved.version=7;saved.courseId=course.courseId;saved.selectedCourseId=course.courseId;saved.courseName=course.courseName;saved.roundHoles=roundModeByHoles(saved.roundHoles).holes;saved.finalResult ||= null;saved.courseTheme ||= COURSE_THEME;saved.seenHoleIntroIds=Array.isArray(saved.seenHoleIntroIds)?saved.seenHoleIntroIds:[];saved.skipHoleIntro=Boolean(saved.skipHoleIntro);saved.characterId ||= character.id;saved.selectedCharacterId ||= saved.characterId;saved.characterName ||= character.name;saved.control ??= saved.accuracy||character.control;saved.shortGame ??= character.shortGame;saved.putting ??= character.putting;saved.aim ||= "center";saved.lastShotOrigin ||= null;
  ...
  const selected=normalizeShotId(saved.selectedShotType);saved.selectedShotType=["normal","attack"].includes(selected)?selected:"normal";if(saved.selectedShotType!==selected)console.warn?.("invalid selectedShotType migrated to normal");delete saved.attackRemaining;delete saved.attackShotsRemaining;delete saved.attackUsed;delete saved.favoriteShot;delete saved.weakShot;delete saved.preferredShot;
  saved.winds ||= holes.map(()=>+(1+Math.random()*5).toFixed(1));saved.shots ||= Array.from({length:18},()=>[]);return saved;
}
function simulateCpu(skill,courseHoles=holes,courseId=selectedCourseId){const coursePenalty=courseId==="shibuya"?.06:0;return courseHoles.map(h=>{const r=Math.random()+(skill-78)*.045-(h.difficulty-3)*.16-coursePenalty;return r>.88?h.par-2:r>.56?h.par-1:r>.17?h.par:r>-.13?h.par+1:h.par+2})}
...
function save(){localStorage.setItem(STORAGE_KEY,JSON.stringify(state));localStorage.setItem(COURSE_SELECTION_KEY,state.courseId||selectedCourseId)}
function normalizeGameSettings(raw={},legacySkip=false){return{...DEFAULT_GAME_SETTINGS,...raw,showHoleIntro:typeof raw.showHoleIntro==="boolean"?raw.showHoleIntro:!legacySkip,enableSwingAnimation:raw.enableSwingAnimation!==false,enableBallAnimation:raw.enableBallAnimation!==false,animationSpeed:raw.animationSpeed==="fast"?"fast":"normal"}}
function loadGameSettings(savedState){try{return normalizeGameSettings(JSON.parse(localStorage.getItem(SETTINGS_KEY))||{},Boolean(savedState?.skipHoleIntro))}catch{return normalizeGameSettings({},Boolean(savedState?.skipHoleIntro))}}
function saveGameSettings(){localStorage.setItem(SETTINGS_KEY,JSON.stringify(gameSettings))}
function animationSpeedMultiplier(){return gameSettings.animationSpeed==="fast"?.65:1}
function optionsFor(current){
  ...
  return FIELD_SHOT_FALLBACK.map(option=>({...option}));
}
function safeShotOptionsFor(current=state){
  if(current.lie==="green")return[{id:"putt",name:"パットする",desc:puttDifficultyLabel(current.distance),risk:0,power:1,recommended:true}];
  let options=optionsFor(current).filter(option=>["normal","attack","strong","layup"].includes(option?.id)).map(normalizeShotOption);
  options=[...new Map(options.map(option=>[option.id,option])).values()].filter(option=>["normal","attack"].includes(option.id));
  if(options.length<2){console.warn?.("shot options empty, fallback applied");options=FIELD_SHOT_FALLBACK.map(option=>({...option}))}
  return FIELD_SHOT_FALLBACK.map(base=>options.find(option=>option.id===base.id)||{...base});
}
function renderShotCards(options=safeShotOptionsFor(state)){
  const container=$("#shotOptions");if(!container){console.warn?.("shot card container not found");return[]}
  if(!Array.isArray(options)||!options.length){console.warn?.("shot options empty, fallback applied");options=FIELD_SHOT_FALLBACK.map(option=>({...option}))}
  const normalized=safeShotOptionsFor(state);
  container.innerHTML=normalized.map((o,i)=>`<button class="shot-button ${o.recommended?"recommended":""}" data-shot="${i}"><strong>${o.name||o.label}</strong><span>${o.desc||""}</span></button>`).join("");
  $$('[data-shot]').forEach((button,i)=>button.onclick=()=>selectShot(normalized[i]));
  return normalized;
}
function ensureShotCardsVisible(){
  const panel=$(".action-panel");if(!panel)return;if(state.started&&!state.complete&&!pendingShot&&!shotLocked&&!isShotAnimating)panel.classList.remove("hidden");
}
function canUseAttack(){return true}
function consumeAttackShot(){return true}
...
const INTRO_AREA_LABELS={park:"公園エリア",shopping:"商店街エリア",river:"川沿いエリア",rooftop:"屋上エリア",station:"駅前エリア",construction:"工事現場エリア",monorail:"モノレール沿い",neon:"ネオン街エリア",crossing:"交差点広場",business:"ビル街",slope:"坂道エリア",overpass:"高架下",plaza:"イベント広場",gate:"シティゲート",rail:"線路沿い",alley:"裏路地",tower:"タワー街",avenue:"大通り",finale:"フィナーレ"};
...
function dismissHoleIntro(){if(!state.started)return;gameSettings.showHoleIntro=!Boolean($("#skipHoleIntroToggle").checked);state.skipHoleIntro=!gameSettings.showHoleIntro;state.seenHoleIntroIds=[...new Set([...(state.seenHoleIntroIds||[]),state.hole])];saveGameSettings();save();setHoleIntroOpen(false)}
function renderSettings(){
  $("#showHoleIntroSetting").checked=gameSettings.showHoleIntro;$("#enableSwingAnimationSetting").checked=gameSettings.enableSwingAnimation;$("#enableBallAnimationSetting").checked=gameSettings.enableBallAnimation;
  $$("[name='animationSpeedSetting']").forEach(input=>input.checked=input.value===gameSettings.animationSpeed);
}
function openSettings(){renderSettings();$("#settingsOverlay").classList.remove("hidden")}
function closeSettings(){applySettingsFromUi();$("#settingsOverlay").classList.add("hidden")}
function applySettingsFromUi(){
  gameSettings=normalizeGameSettings({showHoleIntro:$("#showHoleIntroSetting").checked,enableSwingAnimation:$("#enableSwingAnimationSetting").checked,enableBallAnimation:$("#enableBallAnimationSetting").checked,animationSpeed:$("[name='animationSpeedSetting']:checked")?.value},state.skipHoleIntro);
  state.skipHoleIntro=!gameSettings.showHoleIntro;saveGameSettings();if(state.started)save();if(!gameSettings.showHoleIntro)setHoleIntroOpen(false);
}
function deleteSaveData(){if(!confirm("プレー中のセーブデータを削除します。設定は残します。よろしいですか？"))return;[STORAGE_KEY,"pga-tour-18-save-v5","pga-tour-18-save-v4","pga-tour-18-save-v3","pga-tour-18-save-v2","pga-tour-18-save-v1"].forEach(key=>localStorage.removeItem(key));state={started:false};setHoleIntroOpen(false);closeSettings();switchView("play");render()}
function restartFromScratch(){if(!confirm("現在のラウンド進行を破棄して、最初からやり直します。よろしいですか？"))return;closeSettings();returnToStart()}
function renderCharacterOptions(){
  $("#characterOptions").innerHTML=CHARACTERS.map(character=>`<button class="character-option character-card accent-${character.accent} ${character.id===selectedCharacterId?"selected":""}" data-character="${character.id}">${characterImageMarkup(character,"bust","character-card__bust")}<div class="character-card__content"><header><strong>${character.name}</strong><span>${character.type}</span></header><p>${character.description}</p><div class="character-stats"><span>PWR<b>${character.power}</b></span><span>ACC<b>${character.accuracy}</b></span><span>CTL<b>${character.control}</b></span><span>SG<b>${character.shortGame}</b></span><span>PUTT<b>${character.putting}</b></span></div><div class="character-traits">${character.traits.map(trait=>`<span>${trait}</span>`).join("")}</div></div></button>`).join("");
  $$('[data-character]').forEach(button=>button.onclick=()=>{selectedCharacterId=button.dataset.character;renderCharacterOptions()});
}
function renderCourseOptions(){
  $("#courseOptions").innerHTML=Object.values(COURSES).map(course=>{const available=course.status==="available",selected=available&&course.courseId===selectedCourseId;return`<article class="course-option ${selected?"selected":""} ${available?"":"coming-soon"}" data-course-card="${course.courseId}"><header><strong>${course.courseName}</strong><span>${available?course.difficulty:"COMING SOON"}</span></header><p>${course.description}</p><dl><dt>TYPE</dt><dd>${course.courseType}</dd><dt>FEATURE</dt><dd>${course.features}</dd><dt>LANDMARK</dt><dd>${course.landmarks}</dd><dt>PLAY</dt><dd>${available?"3H / 9H / 18H":"将来実装予定"}</dd></dl><button class="course-select-button" data-course-select="${course.courseId}" ${available?"":"disabled"}>${selected?"選択中":available?"このコースでプレー":"COMING SOON"}</button></article>`}).join("");
  $$("[data-course-select]").forEach(button=>button.onclick=()=>{const course=COURSES[button.dataset.courseSelect];if(!course||course.status!=="available")return;activateCourse(course.courseId,true);renderCourseOptions();updateCourseChrome(course)});
}
...
function lieMultiplierFor(lie,opt,rng=Math.random){const attack=normalizeShotId(opt.id)==="attack";if(lie==="fairway")return .98+rng()*.02;if(lie==="rough")return Math.min(.95,Math.max(.80,.80+rng()*.15-(attack?.03:0)));if(lie==="bunker")return Math.min(.75,Math.max(.50,.50+rng()*.25-(attack?.025:0)));return 1}
function finalDirectionFor(current,timing,h,opt={}){const aim=aimById(current.aim),timingSide=timing.side==="left"?-1:timing.side==="right"?1:0,performance=characterPerformance(current.characterId);const lieSpread=current.lie==="bunker"?1.45:current.lie==="rough"?1.17:current.lie==="fairway"?.86:1;const courseSpread=h.courseDifficulty==="HARD"?1.04:1,gradeSpread={PERFECT:.015,GOOD:.07,NORMAL:.15,MISS:.31,BAD:.54}[timing.grade]*(normalizeShotId(opt.id)==="attack"?1.18:1)*performance.sideMissMultiplier*courseSpread;const precision=Math.max(.55,1-(current.accuracy-60)*.009-(current.control-60)*.005);const windDirection=current.hole%2?-1:1;const windDrift=windDirection*(current.winds[current.hole]-1)*(h.windFactor||1)*.018;const value=Math.max(-1.15,Math.min(1.15,aim.value+timingSide*gradeSpread*lieSpread*precision+windDrift));return{aim,value,side:value<-.14?"left":value>.14?"right":"center",error:Math.abs(value-aim.value)}}
function approachTravelFor(origin,opt,timing,current,rng=Math.random){
  ...
  const shotAdjustment=normalizeShotId(opt.id)==="attack"?.07:0;
  const shortGame=(current.shortGame||75)-75;
  const lieFactor=(origin.lie==="bunker"?.70+shortGame*.003:origin.lie==="rough"?.89+shortGame*.0025:1)*characterPerformance(current.characterId).approachStabilityMultiplier;
...
function shotInChanceFor(origin,timing,current,direction,h){
  ...
  const characterId=current.characterId||current.selectedCharacterId,shotInBias=characterId==="technique"&&distance<=80?1.08:characterId==="power"&&distance>80?1.08:1;
  if(isPar3Tee)return{eligible:true,chance:(grade==="PERFECT"?.003:.0003)*shotInBias,type:"HOLE IN ONE"};
  ...
  return{eligible:true,chance:band*lieAdjustment*shotInBias,type:distance<20?"CHIP IN":distance<=80?"SHOT IN":"MIRACLE SHOT"};
}
...
function resolveFullShot(current,opt,timing,rng=Math.random){
  opt={...opt,id:normalizeShotId(opt.id)};const h=holes[current.hole],wind=current.winds[current.hole],origin=snapshotShotOrigin(current),attacking=opt.id==="attack",badLie=current.lie==="rough"||current.lie==="bunker",direction=finalDirectionFor(current,timing,h,opt),sideRisk=direction.side==="left"?h.leftRisk:direction.side==="right"?h.rightRisk:1,obAligned=h.obSide==="both"||h.obSide===direction.side;
  ...
  const canOB=attacking&&obAligned&&h.obSide!=="none"&&(largeMiss||edgeAim&&missTowardAim)&&(badLie||wind>=3.5||edgeAim);const obChance=canOB?Math.min(.24,(.02+sideRisk*.018+(edgeAim?.035:0)+(wind>=5?.025:0)+(badLie?.03:0)+(timing.grade==="BAD"?.04:0))*(h.obRiskMultiplier||1)):0;
  ...
  const waterSide=h.waterSide||"right",canWater=h.waterRisk>0&&direction.side===waterSide&&(largeMiss||edgeAim&&missTowardAim);const waterChance=canWater?Math.min(.24,.01+h.waterRisk*.018+(attacking?.055:0)+(edgeAim?.025:0)):0;
  ...
  const lieMultiplier=lieMultiplierFor(origin.lie,opt,rng),powerMultiplier=(.88+(current.power||78)*.0015)*characterPerformance(current.characterId).baseDistanceMultiplier,windMultiplier=1+((current.hole%2?-1:1)*direction.value*(wind-1)*.008),qualityPower={PERFECT:1.04,GOOD:1,NORMAL:.90,MISS:.72,BAD:.57}[timing.grade]+((current.control||78)-70)*.001*(timing.grade==="MISS"||timing.grade==="BAD"?1:0),shortGameMultiplier=(origin.distance<=95||origin.lie==="bunker")?.88+(current.shortGame||75)*.0015:1;
  ...
  const accuracyBoost=((current.accuracy||76)-76)*.012+((current.control||76)-76)*.006-direction.error*.20-opt.risk*.025-h.difficulty*.018,approachBoost=approach&&(timing.grade==="PERFECT"||timing.grade==="GOOD")?(timing.grade==="PERFECT"?.18:.10):0,greenRange=(timing.grade==="PERFECT"?28:timing.grade==="GOOD"?22:16)+(attacking&&timing.grade==="PERFECT"?8:0)+(approachBoost?7:0),reachedGreenArea=current.distance<=greenRange;
  if(reachedGreenArea&&rng()<Math.max(.08,Math.min(.98,.72+accuracyBoost+approachBoost))){current.lie="green";const basePutt={PERFECT:1.4,GOOD:3,NORMAL:6,MISS:10,BAD:15}[timing.grade]*(attacking?.72:1);current.distance=+(Math.max(.5,basePutt*(.65+rng()*.7)).toFixed(1));current.position={progress:.98,lateral:direction.value*.12};current.greenPosition=greenPointForDistance(current.distance,direction.side);return{finished:false,penalty:false,outcome:"green",direction:direction.side,title:"グリーンオン",urbanHazard:h.greenLabel,text:`${h.greenLabel}へオン。ピンまで ${current.distance}m`,shotNumber}}
  if(reachedGreenArea)current.distance=Math.max(6,Math.round(7+(1-timing.quality)*22+rng()*12));
  const bunkerChance=Math.max(0,h.bunkerRisk*.035+(timing.grade==="BAD"?.12:timing.grade==="MISS"?.06:0)+(attacking?.05:0)-accuracyBoost*.18+direction.error*.05);if(current.distance<95&&rng()<bunkerChance){current.lie="bunker";return{finished:false,penalty:false,outcome:"bunker",direction:direction.side,title:`${direction.side==="left"?"左":"右"}${h.bunkerLabel}`,urbanHazard:h.bunkerLabel,text:`${h.bunkerLabel}。残り ${current.distance}ヤード`,shotNumber}}
  const roughChance=Math.min(.92,Math.max(.02,.08+sideRisk*.035+direction.error*.32+(badLie?.06:0)+opt.risk*.025-((current.accuracy||76)-70)*.008));if(rng()<roughChance){current.lie="rough";return{finished:false,penalty:false,outcome:"rough",direction:direction.side,title:`${direction.side==="left"?"左":"右"}${h.roughLabel}`,urbanHazard:h.roughLabel,text:`${h.roughLabel}。残り ${current.distance}ヤード`,shotNumber}}
...
function animateShot(plan,result){
  if(!gameSettings.enableBallAnimation){isShotAnimating=false;return Promise.resolve()}
...
function resultComment(opt,timing,result){
  ...
  if(result.outcome==="green")return opt.id==="attack"&&hit==="PERFECT"?`強めの完璧なインパクト。${result.urbanHazard||"特設グリーン"}へナイスオン。`:`${hit}のショットで${result.urbanHazard||"特設グリーン"}を捉えた。`;
  if(opt.id==="attack"&&hit==="PERFECT")return `強めに振り切って完璧なインパクト。${result.urbanHazard||"特設フェアウェイ"}中央へ。`;
...
async function renderCharacterShotAnimation({character,shotType,timingResult,isPutt,missDirection}){
  ...
  const speed=animationSpeedMultiplier(),labelText=timingResult?.label||"SHOT",typeLabel=isPutt?"パット":normalizeShotId(shotType)==="attack"?"強めショット":"通常ショット",fallbackDuration=Math.round((isPutt?640:timingResult?.grade==="PERFECT"?820:760)*speed);
  ...
  try{
    ...
    if(usesSprites){const frameImage=image.querySelector(".character-sprite-frame");if(frameImage){await playSpriteFrames(frameImage,frames,character,isPutt,speed);await new Promise(resolve=>setTimeout(resolve,Math.round(90*speed)))}else await new Promise(resolve=>setTimeout(resolve,fallbackDuration))}else await new Promise(resolve=>setTimeout(resolve,fallbackDuration));
...
function parThrough(n,source=state){return getCurrentHoles(source).slice(0,n).reduce((a,h)=>a+h.par,0)}
...
function cpuScoreAt(cpu,thru,source=state){return cpu.scores.slice(0,thru).reduce((a,b)=>a+b,0)-parThrough(thru,source)}
...
function getRanking(){const thru=completedHoles();return[...state.cpu.map(c=>({name:c.name,rel:cpuScoreAt(c,thru,state),thru:state.complete?"F":thru,country:c.country})),{name:state.name,rel:playerTotal(thru)-parThrough(thru,state),thru:state.complete?"F":thru,country:"YOU",player:true}].sort((a,b)=>a.rel-b.rel)}
function rankingForRound(roundHoles,source=state){const par=parThrough(roundHoles,source),playerTotalForRound=source.scores.slice(0,roundHoles).reduce((sum,score)=>sum+(score||0),0);return[...source.cpu.map(cpu=>{const total=cpu.scores.slice(0,roundHoles).reduce((sum,score)=>sum+score,0);return{name:cpu.name,country:cpu.country,score:total-par,total,thru:"F"}}),{name:source.name,country:"YOU",score:playerTotalForRound-par,total:playerTotalForRound,thru:"F",player:true}].sort((a,b)=>a.score-b.score).map((row,index)=>({...row,rank:index+1}))}
function roundStats(roundHoles,source=state){
  const sourceHoles=getCurrentHoles(source),scores=source.scores.slice(0,roundHoles),logs=source.shots.slice(0,roundHoles).flatMap((holeShots,holeIndex)=>holeShots.filter(shot=>shot.type==="shot").map(shot=>({...shot,choice:displayShotChoice(shot.choice),hole:holeIndex+1,holeName:sourceHoles[holeIndex]?.name}))),fullShots=logs.filter(log=>log.choice!=="パットする"),putts=logs.filter(log=>log.choice==="パットする"),strongShots=logs.filter(log=>isStrongChoice(log.choice)),parOn=fullShots.filter(log=>log.outcome==="green").length;
  const stat={birdies:0,pars:0,bogeys:0,doubles:0,ob:logs.filter(log=>log.outcome==="ob").length,wh:logs.filter(log=>log.outcome==="wh").length,bunkers:logs.filter(log=>log.outcome==="bunker").length,shotIns:logs.filter(log=>Boolean(log.shotInType)).length,fairwayRate:fullShots.length?Math.round(logs.filter(log=>log.outcome==="fairway").length/fullShots.length*100):0,greenRate:roundHoles?Math.round(parOn/roundHoles*100):0,totalPutts:putts.length,averagePutts:roundHoles?+(putts.length/roundHoles).toFixed(1):0,strongUsed:strongShots.length,strongSuccess:strongShots.length?Math.round(strongShots.filter(log=>log.outcome==="green"||log.outcome==="fairway"||log.outcome==="shot-in").length/strongShots.length*100):0};
  scores.forEach((score,index)=>{const diff=score-sourceHoles[index].par;if(diff<=-1)stat.birdies++;else if(diff===0)stat.pars++;else if(diff===1)stat.bogeys++;else stat.doubles++});return{...stat,logs};
}
function shotLabel(log){const hole=holes[(log.hole||1)-1];return `${log.hole}H ${log.holeName||hole?.name||"URBAN COURSE"} · 第${log.stroke}打`}
function bestAndTrouble(stats){
  const best=stats.logs.map(log=>{let value=0;if(log.shotInType==="HOLE IN ONE")value=300;else if(log.shotInType==="MIRACLE SHOT"||log.shotInType==="SHOT IN")value=260;else if(log.shotInType==="CHIP IN")value=240;else if(isStrongChoice(log.choice)&&log.timing?.grade==="PERFECT"&&log.outcome==="green")value=120;else if(log.choice==="パットする"&&log.outcome==="cup")value=95+(log.distanceBefore||0);else if(log.outcome==="green"&&log.timing?.grade==="PERFECT")value=85;else if(log.outcome==="fairway"&&log.timing?.grade==="GOOD")value=55;return{...log,value}}).sort((a,b)=>b.value-a.value)[0];
...
function pgaComment(rank,stats){if(rank===1)return"見事な優勝です！フィールドを引っ張る堂々たるラウンドでした。";if(stats.shotIns)return"スーパーショットで直接カップイン！都市コースを沸かせる一打でした。";if(stats.ob+stats.wh>=2)return"狙い方向を少し安全にすると、さらに安定しそうです。";if(stats.averagePutts>=2.1)return"グリーン上で少し苦戦しました。距離感を丁寧に合わせましょう。";if(stats.strongUsed>=2&&stats.strongSuccess>=70)return"強めショットの判断が光りました。大胆さがスコアにつながっています。";if(stats.birdies>=2)return"チャンスをしっかり決めました。バーディの量産が素晴らしいです。";if(rank<=10)return"安定したプレーでした。次は表彰台を狙えます。";return"最後まで戦い抜きました。次のラウンドでリベンジしましょう。"}
function buildFinalResult(source=state){const course=getCurrentCourse(source),roundHoles=source.roundHoles,scores=source.scores.slice(0,roundHoles),par=parThrough(roundHoles,source),ranking=rankingForRound(roundHoles,source),player=ranking.find(row=>row.player),stats=roundStats(roundHoles,source),stories=bestAndTrouble(stats);return{mode:roundModeByHoles(roundHoles).label,roundHoles,courseTheme:COURSE_THEME,courseTitle:COURSE_TITLE,courseId:course.courseId,courseName:course.courseName,courseSubtitle:course.courseName,characterName:source.characterName,characterId:source.characterId,rank:player.rank,total:player.total,toPar:player.score,thru:roundHoles,scores,par,evaluation:roundEvaluation(player.rank),stats,bestShot:stories.best,troubleShot:stories.trouble,ranking:pgaSafeRanking(ranking),comment:pgaComment(player.rank,stats)}}
...
function updateCourseChrome(course=getCurrentCourse(state)){
  $("#currentCourseName").textContent=course.courseName;$("#startCourseEyebrow").textContent=`${course.shortName} · ${course.difficulty} COURSE`;$("#rankingCourseName").textContent=`${COURSE_TITLE} · ${course.courseName}`;
}

function renderCourse(h){
  const course=getCurrentCourse(state),onGreen=state.lie==="green",features=h.features||[],show=(id,feature)=>$(id)?.classList.toggle("hidden",!features.includes(feature)),landmarks={park:"#landmarkPark",shopping:"#landmarkShopping",river:"#landmarkRiver",rooftop:"#landmarkRooftop",station:"#landmarkStation",construction:"#landmarkConstruction",monorail:"#landmarkMonorail",neon:"#landmarkNeon",crossing:"#landmarkShopping",business:"#landmarkTower",slope:"#landmarkShopping",overpass:"#landmarkMonorail",plaza:"#landmarkShopping",gate:"#landmarkTower",rail:"#landmarkMonorail",alley:"#landmarkConstruction",tower:"#landmarkTower",avenue:"#landmarkShopping",finale:"#landmarkTower"},visual=$("#courseVisual");visual.dataset.course=course.courseId;visual.dataset.tone=h.tone||"day";visual.dataset.time=h.timeOfDay||h.tone||"day";visual.dataset.area=h.areaType||"park";visual.dataset.mapTheme=h.mapTheme||"urban";$("#holeName").textContent=`${h.number}H · ${h.name}`;$("#holeComment").textContent=h.comment;$("#courseMap").classList.toggle("hidden",onGreen);$("#greenView").classList.toggle("hidden",!onGreen);visual.classList.toggle("green-active",onGreen);
...
function renderResult(){
  const result=state.finalResult;if(!result)return;const course=courseById(result.courseId||state.courseId),character=characterById(result.characterId);$("#resultModeLabel").textContent=`${result.courseTitle||COURSE_TITLE} · ${result.courseName||course.courseName} · ${result.mode} CITY PLAY`;$("#resultCourseName").textContent=result.courseName||course.courseName;$("#resultGrade").textContent=result.evaluation;$("#resultCharacterVisual").innerHTML=characterImageMarkup(character,"bust","result-character__image");$("#resultCharacter").textContent=`${result.characterName} · ${character.type}`;$("#resultRank").textContent=formatRank(result.rank);$("#resultTotal").textContent=result.total;$("#resultThru").textContent=result.thru;setScoreEl($("#resultToPar"),result.toPar);
  const hs=course.holes.slice(0,result.roundHoles),out=result.scores.slice(0,Math.min(9,result.roundHoles)).reduce((sum,score)=>sum+score,0),inScore=result.roundHoles===18?result.scores.slice(9,18).reduce((sum,score)=>sum+score,0):null;
  ...
  const statItems=[["BIRDIE",result.stats.birdies],["PAR",result.stats.pars],["BOGEY",result.stats.bogeys],["DBL+",result.stats.doubles],["OB",result.stats.ob],["WH",result.stats.wh],["BUNKER",result.stats.bunkers],["FW KEEP",`${result.stats.fairwayRate}%`],["GIR",`${result.stats.greenRate}%`],["PUTTS",result.stats.totalPutts],["AVG PUTT",result.stats.averagePutts],["STRONG",`${result.stats.strongUsed||0}/${result.stats.strongSuccess||0}%`]];
  $("#resultStats").innerHTML=statItems.map(([label,value])=>`<div class="stat-card"><span>${label}</span><b>${value}</b></div>`).join("");
  const best=result.bestShot,trouble=result.troubleShot;$("#bestShotTitle").textContent=best?`${shotLabel(best)} · ${best.shotInType?`${best.shotInType} · `:""}${displayShotChoice(best.choice)} × ${best.timing.grade}`:"安定したラウンド";$("#bestShotText").textContent=best?`${best.shotInType?`残り${best.distanceBefore}Y ${best.lie||"グリーン外"}から ${best.shotInType}! `:""}${best.text}${best.distanceBefore&&!best.shotInType?`（開始時 ${best.distanceBefore}${displayShotChoice(best.choice)==="パットする"?"m":"Y"}）`:""}`:"大きなチャンスを着実にまとめました。";$("#troubleShotTitle").textContent=trouble?`${shotLabel(trouble)} · ${displayShotChoice(trouble.choice)} × ${trouble.timing.grade}`:"大きなトラブルなし";$("#troubleShotText").textContent=trouble?trouble.text:"大きなミスを避けてプレーできました。";
...
function render(){
  const course=state.started?activateCourse(state.courseId):getCurrentCourse();updateCourseChrome(course);$("#startPanel").classList.toggle("hidden",state.started);$("#gamePanel").classList.toggle("hidden",!state.started);if(!state.started){setHoleIntroOpen(false);renderCourseOptions();renderModeOptions();renderCharacterOptions();renderEmptyScore();return}
  const h=holes[state.hole],thru=completedHoles(),pRel=playerTotal(thru)-parThrough(thru,state),ranking=getRanking();$("#playerPosition").textContent=formatRank(ranking.findIndex(x=>x.player)+1);setScoreEl($("#liveScore"),pRel);$("#thruValue").textContent=state.complete?"F":thru||"—";
  ...
  const activeCharacter=characterById(state.characterId);$("#lieValue").textContent=urbanLieLabel(h,state.lie);$("#distanceValue").textContent=state.lie==="green"?`${state.distance}m`:`${state.distance}y`;$("#distancePill").textContent=`${state.distance} ${state.lie==="green"?"M":"YDS"}`;$("#abilityText").textContent=`POWER ${state.power} · ACCURACY ${state.accuracy} · CONTROL ${state.control}`;$("#characterStatus").innerHTML=`${characterImageMarkup(activeCharacter,"icon","player-status__icon")}<span><b>${activeCharacter.name}</b> · ${activeCharacter.type}<small>${state.roundHoles}H PLAY / ${activeCharacter.traits.join(" · ")}</small></span>`;renderCourse(h);
  $("#aimPanel").classList.toggle("hidden",state.lie==="green");if(state.lie!=="green")renderAimOptions();$(".section-title span").textContent=state.lie==="green"?"PUTT":"SELECT SHOT";ensureShotCardsVisible();renderShotCards();renderScorecard();renderRanking();
...
function startGame(){state=freshState($("#playerNameInput").value,selectedCharacterId,selectedRoundHoles,selectedCourseId);save();render()}
function startAgain(characterId=state.characterId,roundHoles=state.roundHoles){const name=state.name,courseId=state.courseId||selectedCourseId;selectedCharacterId=characterId;selectedRoundHoles=roundHoles;state=freshState(name,characterId,roundHoles,courseId);save();switchView("play");render()}
function returnToStart(){selectedCharacterId=state.characterId||selectedCharacterId;selectedRoundHoles=state.roundHoles||selectedRoundHoles;activateCourse(state.courseId||selectedCourseId,true);state={started:false};[STORAGE_KEY,"pga-tour-18-save-v5","pga-tour-18-save-v4","pga-tour-18-save-v3","pga-tour-18-save-v2","pga-tour-18-save-v1"].forEach(key=>localStorage.removeItem(key));switchView("play");render()}
...
$$('[data-view]').forEach(t=>t.onclick=()=>switchView(t.dataset.view));$("#startButton").onclick=startGame;$("#newGameButton").onclick=resetGame;$("#settingsButton").onclick=openSettings;$("#settingsCloseButton").onclick=closeSettings;$("#settingsCloseButtonBottom").onclick=closeSettings;$("#settingsRestartButton").onclick=restartFromScratch;$("#settingsDeleteSaveButton").onclick=deleteSaveData;["#showHoleIntroSetting","#enableSwingAnimationSetting","#enableBallAnimationSetting"].forEach(id=>$(id).onchange=applySettingsFromUi);$$("[name='animationSpeedSetting']").forEach(input=>input.onchange=applySettingsFromUi);$("#swingButton").onclick=stopTiming;$("#cancelTimingButton").onclick=cancelTiming;$("#viewRankingButton").onclick=()=>{$("#modalBackdrop").classList.add("hidden");switchView("ranking")};$("#closeModalButton").onclick=()=>{$("#modalBackdrop").classList.add("hidden");switchView("score")};$("#playAgainButton").onclick=()=>startAgain();$("#changeCharacterButton").onclick=()=>returnToStart();$("#modeSelectButton").onclick=()=>returnToStart();$("#resultRankingButton").onclick=()=>switchView("ranking");preloadCharacterImages();if("serviceWorker" in navigator&&location.protocol.startsWith("http"))navigator.serviceWorker.register("sw.js").catch(()=>{});render();if(state.complete&&state.finalResult)switchView("result");
